...
/**
 * Api services for the `Crawlwebtocsv` model.
 */
@Injectable()
export class CrawlwebtocsvApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public crawlurl(id: any = {}, url: any = {}, term: any = {}, people: any = {}, companies: any = {}, locations: any = {}, findlist: any = {}, depth: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Crawlwebtocsvs/crawlurl/:id";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
